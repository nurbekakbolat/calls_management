      ...
      <Grid item xs={4}>
        <Grid container spacing={2}>
          <Grid item xs={4} style={{}}>
            <Typography fontSize={12}>Новые звонки</Typography>
            <LinearProgress variant="determinate" value={newCallsBar()} />
          </Grid>
          <Grid item xs={4} style={{ fontSize: "12px" }}>
            <Typography fontSize={12}> Качество разговора</Typography>
          </Grid>
          <Grid item xs={4} style={{ fontSize: "12px" }}>
            <Typography fontSize={12}> Конверсия в заказ</Typography>
          </Grid>
        </Grid>
      </Grid>
